...
const handleSubmit = async (e) => {
  ...
  return (
    <div style={{backgroundColor:"#81b5fa",paddingBottom:"170px"}}> 
        <Vnavbar/>
    <div className="max-w-md mx-auto mt-52 p-4 border rounded shadow-lg" style={{backgroundColor:"lightskyblue"}}>
